            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 col-lg-4 mx-auto">
                    <div class="login-form mt-5 mt-md-0"><img src="frontend/img/logo.png" class="logo img-responsive mb-4 mb-md-6" alt="">
                        <h1 class="text-darker bold">Change Password</h1>
                        @if ($errors->any())
                        ...
                        @endif
                        <form class="form cozy" action="{{ route('frn.customer.change-password',$customer->id) }}" method="POST">@csrf
                            ...
                            <div class="form-group d-flex align-items-center justify-content-between">
                               <button type="submit" class="btn btn-primary btn-rounded">Change <i class="fas fa-long-arrow-alt-right ms-2"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
