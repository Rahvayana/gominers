        ...
        <div class="container">
            ...
            <div class="row gap-y">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-blog shadow-box shadow-hover border-0"><a href="{{ route('blog.detail', $blog->slug) }}"><img class="card-img-top img-responsive" src="{{$blog->thumbnail}}" style="max-width: 350px; max-height: 200px;" alt=""></a>
                        <div class="card-body">
