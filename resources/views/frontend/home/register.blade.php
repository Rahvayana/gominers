...
<head>
    ...
    <title>Gominers - Register</title><!-- themeforest:css -->
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-7 fullscreen-md d-flex justify-content-center align-items-center overlay overlay-primary alpha-8 image-background cover">
                    <div class="content">
                        ...
                        <p class="lead text-contrast">Get started with Dashcore</p>
                        <hr class="mt-md-6 w-25">
                        <div class="d-flex flex-column">
                            <p class="small bold text-contrast">Or register with</p>
                ...
                <div class="col-md-5 col-lg-4 mx-auto">
                    <div class="login-form mt-5 mt-md-0"><img src="frontend/img/logo.png" class="logo img-responsive mb-4 mb-md-6" alt="">
                        ...
                        <p class="text-secondary mt-0">Already have an account? <a href="{{ route('frn.customer.login-view') }}" class="text-primary bold">Login here</a></p>
                        @if ($errors->any())
                        ...
                        @endif
                        <form class="form cozy" action="{{ route('frn.customer.register-process') }}" method="POST">@csrf
                            <label class="form-label">Name</label>
                            <div class="form-group has-icon">
                                <input type="text" id="login_username" name="name" class="form-control form-control-rounded" placeholder="Your Account Name" required>
                                <i class="icon fas fa-user"></i>
                            </div>
                            <label class="form-label">Email</label>
                            <div class="form-group has-icon">
                                <input type="email" id="login_username" name="email" class="form-control form-control-rounded" placeholder="Your Email Account" required>
                                <i class="icon fas fa-user"></i>
                            </div>
                            ...
                            <div class="form-group has-icon">
                                <input type="password" id="login_password" name="password_confirmation" class="form-control form-control-rounded" placeholder="Your password" required>
                                <i class="icon fas fa-lock"></i>
                            </div>
                            <div class="form-group d-flex align-items-center justify-content-between">
                               <button type="submit" class="btn btn-primary btn-rounded">Register <i class="fas fa-long-arrow-alt-right ms-2"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
