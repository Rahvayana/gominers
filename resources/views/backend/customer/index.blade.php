            ...
            <div class="col-md-12">
                <div class="breadcrumb-contents">
                    ...
                    <div class="breadcrumb">
                        <ul>
                            <li>
                                <a href="{{ route('bcn.dashboard.index') }}">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="#">Customer</a>
                            </li>
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="filter-bar clearfix filter-bar2">
                    <div class="dashboard__title" style="padding: 30px;">
                        <h3>{{($customers->total())}} Users Sign Up</h3>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-sm-12">
                            <div class="product__description">
                                <img src="{{$customer->foto??'/backend/img/pur1.jpg'}}" alt="Purchase image">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="product__additional_info">
                                <ul>
                                    <li>
                                        <p>
                                            <span>Date: {{$customer->tanggal_lahir}}</span>
                                        </p>
                                    </li>
                                    <li class="license">
                                        <p>
                                            <span>Province:</span> {{$customer->provinsi}}
                                        </p>
                                    </li>
                                    <li>
                                        <p>
                                            <span>City:</span> {{$customer->kota}}
                                        </p>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product__price_download">
                                <div class="item_price v_middle">
                                    <span>{{$customer->seller==1?'Seller':'User'}}</span>
                                </div>
                ...
                <div class="col-md-12">
                    ...
                    <nav class="pagination-default ">
                        {{ $customers->links('backend.customer.pagination') }}
