...
<head>
    ...
    <!-- inject:css-->
    <link rel="stylesheet" href="/backend/vendor_assets/css/bootstrap/bootstrap.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/animate.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/jquery-ui.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/line-awesome.min.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/magnific-popup.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/owl.carousel.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/select2.min.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/simple-line-icons.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/slick.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/trumbowyg.min.css">
    <link rel="stylesheet" href="/backend/vendor_assets/css/venobox.css">
    <link rel="stylesheet" href="/backend/style.css">
    <!-- endinject -->
    <!-- Favicon Icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/backend/img/favicon-32x32.png">
</head>
...
<body class="dashboard-page preload">
                        ...
                        <div class="menu-fullwidth">
                            <div class="logo-wrapper">
                                <div class="logo logo-top">
                                    <a href="index.html"><img src="/backend/img/logo.png" alt="logo image" class="img-fluid"></a>
                                </div>
                            </div>
                                ...
                                <div class="author-area">
                                                ...
                                                <div class="dropdown notification--dropdown">
                                                    ...
                                                    <div class="notifications_module">
                                                        <div class="notification">
                                                            <div class="notification__info">
                                                                <div class="info_avatar">
                                                                    <img src="/backend/img/notification_head.png" alt="">
                                                                </div>
                                                                <div class="info">
                                                                    <p>
                                                        ...
                                                        <div class="notification">
                                                            <div class="notification__info">
                                                                <div class="info_avatar">
                                                                    <img src="/backend/img/notification_head2.png" alt="">
                                                                </div>
                                                                <div class="info">
                                                                    <p>
                                                        ...
                                                        <div class="notification">
                                                            <div class="notification__info">
                                                                <div class="info_avatar">
                                                                    <img src="/backend/img/notification_head3.png" alt="">
                                                                </div>
                                                                <div class="info">
                                                                    <p>
                                                        ...
                                                        <div class="notification">
                                                            <div class="notification__info">
                                                                <div class="info_avatar">
                                                                    <img src="/backend/img/notification_head4.png" alt="">
                                                                </div>
                                                                <div class="info">
                                                                    <p>
                                                                        <span>Anderson</span> added to Favourite
                                                ...
                                                <div class="dropdown messaging--dropdown">
                                                    ...
                                                    <div class="messages">
                                                        ...
                                                        <a href="message.html" class="message recent">
                                                            <div class="message__actions_avatar">
                                                                <div class="avatar">
                                                                    <img src="/backend/img/notification_head5.png" alt="">
                                                                </div>
                                                            </div>
                                                            <!-- end /.actions -->
                                                            <div class="message_data">
                                                        ...
                                                        <div class="cart_list">
                                                            <div class="cart_product">
                                                                <div class="product__info">
                                                                    <div class="thumbn">
                                                                        <img src="/backend/img/capro1.jpg" alt="cart product thumbnail">
                                                                    </div>
                                                                    <div class="info">
                                                                        ...
                                                                        <div class="cat">
                                                                            <a href="#">
                                                                                <img src="/backend/img/catword.png" alt="">Wordpress</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="cart_product">
                                                                <div class="product__info">
                                                                    <div class="thumbn">
                                                                        <img src="/backend/img/capro2.jpg" alt="cart product thumbnail">
                                                                    </div>
                                                                    <div class="info">
                                    ...
                                    <div class="author-author__info has_dropdown">
                                        <div class="author__avatar online">
                                            <img src="/backend/img/user-avater.png" alt="user avatar" class="rounded-circle">
                                        </div>
                                        <div class="dropdown dropdown--author">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <button class="icon-logout" style="background: none; border: none;" href="{{ route('frn.customer.logout') }}"
                                    ...
                                    <div class="offcanvas-menu closed">
                                        ...
                                        <div class="author-author__info">
                                            <div class="author__avatar v_middle">
                                                <img src="/backend/img/user-avater.png" alt="user avatar">
                                            </div>
                                        </div>
                                        <!--end /.author-author__info-->
                                        <div class="author__notification_area">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="dashboard_menu">
                            <li class="{{Route::currentRouteNamed('bcn.dashboard.*') ? 'active' : ''}}">
                                <a href="{{ route('bcn.dashboard.index') }}"><span class="lnr icon-home"></span>Dashboard</a>
                            </li>
                            <li>
                                <a href="dashboard-setting.html"><span class="lnr icon-settings"></span>Setting</a>
                            </li>
                            <li class="{{Route::currentRouteNamed('bcn.customer.*') ? 'active' : ''}}">
                                <a href="{{ route('bcn.customer.index') }}"><span class="lnr icon-user"></span>Customers</a>
                            </li>
                            <li>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget">
                            <div class="widget-about">
                                <img src="/backend/img/footer-logo.png" alt="" class="img-fluid">
    ...
    <!-- inject:js-->
    <script src="/backend/vendor_assets/js/jquery/jquery-1.12.4.min.js"></script>
    <script src="/backend/vendor_assets/js/jquery/uikit.min.js"></script>
    <script src="/backend/vendor_assets/js/bootstrap/popper.js"></script>
    <script src="/backend/vendor_assets/js/bootstrap/bootstrap.min.js"></script>
    <script src="/backend/vendor_assets/js/chart.bundle.min.js"></script>
    <script src="/backend/vendor_assets/js/grid.min.js"></script>
    <script src="/backend/vendor_assets/js/jquery-ui.min.js"></script>
    <script src="/backend/vendor_assets/js/jquery.barrating.min.js"></script>
    <script src="/backend/vendor_assets/js/jquery.countdown.min.js"></script>
    <script src="/backend/vendor_assets/js/jquery.counterup.min.js"></script>
    <script src="/backend/vendor_assets/js/jquery.easing1.3.js"></script>
    <script src="/backend/vendor_assets/js/jquery.magnific-popup.min.js"></script>
    <script src="/backend/vendor_assets/js/owl.carousel.min.js"></script>
    <script src="/backend/vendor_assets/js/select2.full.min.js"></script>
    <script src="/backend/vendor_assets/js/slick.min.js"></script>
    <script src="/backend/vendor_assets/js/tether.min.js"></script>
    <script src="/backend/vendor_assets/js/trumbowyg.min.js"></script>
    <script src="/backend/vendor_assets/js/venobox.min.js"></script>
    <script src="/backend/vendor_assets/js/waypoints.min.js"></script>
    <script src="/backend/theme_assets/js/dashboard.js"></script>
    <script src="/backend/theme_assets/js/main.js"></script>
    <script src="/backend/theme_assets/js/map.js"></script>
    <!-- endinject-->
    @yield('script')
</body>
