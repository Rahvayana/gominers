...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Gominers - Admin Template</title>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('bcn.dashboard.index') }}" class="waves-effect">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('bcn.post.blog') }}">Blog</a></li>
                                    <li><a href="{{ route('bcn.post.video') }}">Video</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('bcn.customer.index') }}">Customers</a></li>
                                    <li><a href="{{ route('bcn.customer.verify-user') }}">Verify Seller</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('bcn.post.product') }}">Product</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('bcn.setting.index') }}">API Key</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('bcn.transaction.index') }}">Transactions</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
